...
export const SYSTEMS = [
  ...
  {
    id: 'kestrel', name: 'Kestrel Verge', ly: [4.2, 0.6, -1.1], star: COLORS.gold, nebula: 0x8a4a12, gate: { name: 'Verge Gate', pos: au(1.7, -0.1, 2.3) },
    sites: [
  ...
  {
    id: 'umbra', name: 'Umbra Tessellate', ly: [-3.1, -2.2, 5.4], star: COLORS.violet, nebula: 0x4a1a8a, gate: { name: 'Tessel Gate', pos: au(-2.3, 0.13, -2.0) },
    sites: [
